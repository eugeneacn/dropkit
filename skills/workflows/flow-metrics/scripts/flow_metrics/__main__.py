...
the documented invocation in ``SKILL.md`` is runnable from a dropkit
clone. The kit-installer ships a ``flow-metrics`` console-script shim
that calls the same ``main`` function — both forms produce identical
behaviour.
